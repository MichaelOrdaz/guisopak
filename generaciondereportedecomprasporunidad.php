...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header" style="color: #337ab7;">Generación de reporte de compras por unidad</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <button class="btn btn-primary btn-lg btn-block">Generar reporte de compras por unidad</button>
                    </div>
                    <!-- /.col-lg-6 (nested) -->
                    <!-- /.col-lg-6 (nested) -->
                </div>
