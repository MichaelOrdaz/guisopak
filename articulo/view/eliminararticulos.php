        ...
        <div class="row">
                    ...
                    <div class="col-md-6">
                            <div class="form-group">
                                <label style="color: #337ab7;">*Codigo del articulo</label>
                                <input class="form-control" placeholder="" id="idarticulo" disabled>
                            </div>
                            <div class="form-group">
                                <label style="color: #337ab7;">*Nombre</label>
                                <input list="nombre" class="form-control" id="art" placeholder=" -- Seleccione nombre -- " required maxlength="60">
                                <datalist id="nombre">
                                </datalist>
                            </div>
                            <div class="form-group">
