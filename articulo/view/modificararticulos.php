        ...
        <div class="row">
            ...
            <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="" disabled id="codigoarticulo" required maxlength="60" pattern="[ A-Za-z0-9]{1,60}">
                    </div>
                    <div class="form-group">
                        <label style="color: #337ab7;">Nombre</label>
                        <input list="nombre" class="form-control" id="art" placeholder=" -- Seleccione nombre -- " required maxlength="60" pattern="[ A-Za-z0-9ÁÉÍÓÚáéíóúÑ]{1,60}">
                        <datalist id="nombre">
                        </datalist>
                    </div>
                    <div class="form-group">
            ...
            <div class="col-md-6">
                    <div class="form-group">
                        <label style="color: #337ab7;">Minimo</label>
                    ...
                    <div class="form-group">
                        <label style="color: #337ab7;">Maximo</label>
...
tabla+="<option>"+value.nombre+"</option>";
});
$('#nombre').html(tabla);
},
});
