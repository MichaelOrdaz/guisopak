...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header" style="color: #337ab7;">Generación de oc</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="col-md-2">
                <label style="color: #337ab7;padding-left: 200px;margin-top: 8px;">*ID orden:</label>
                </div>
                <div class="col-md-8 col-sm-12">
                <input class="form-control" placeholder="Ingrese clave orden" id="telefono" style="width: 100%;margin-left: 40px;">
                </div>
                </div>
