          ...
          <ul class="nav" id="side-menu" >
            ...
            <li>
              ...
              <ul class="nav nav-second-level">
                ...
                <li>
                  <a href="OC/view/generaciondereportedecomprasporunidad.php" class="ajaxLink">Generación de reporte de compras por unidad</a>
                </li>
              </ul>
            </li>
            ...
            <li>
              <a href="#"><i class="fa fa-file-excel-o fa-fw"></i> Compras</a>
                <ul class="nav nav-second-level">
                <li>
