...
$unidad = filter_input(INPUT_POST, 'unidadCliente', FILTER_VALIDATE_INT);
$cliente = filter_input(INPUT_POST, 'cliente', FILTER_VALIDATE_INT);


$r = $db->query("SELECT unidad.unidad, cliente.nombre FROM unidad JOIN cliente ON cliente.idCliente=unidad.cliente WHERE unidad.idUnidad = '{$unidad}' LIMIT 1");
