...
<div class="row">
    <div class="col-md-6 col-sm-12">
        <div class="row">
            ...
            <div class="col-md-9 col-sm-12">
                <input class="form-control" type="text" name="unidadA" value="">
            </div>
        </div>
    </div>
    <div class="col-md-6 col-sm-12">
...
<script type="text/javascript">
    ...
    function seleccionarFila()
    {
        ...
        if ( $(this).attr( "class" ) == "danger elegido" )
        {
            ...
            $("select[name='articulo']").val( idArticulo );
    ...
    function rellenarPrecio()
    {
        ...
        {
            _json_response_[ 0 ] = ( Number( _json_response_[ 0 ] ) * Number( _json_response_[ 5 ] ) ).toString();
            $("[name='costo']").text( _json_response_[ 0 ] );
            $("[name='unidadA']").val( _json_response_[ 4 ] + " de " +  _json_response_[ 5 ] + " " + _json_response_[ 3 ]);
        }
        else
        {
            $("[name='costo']").text( _json_response_[ 0 ] );
            $("[name='unidadA']").val( _json_response_[ 3 ] );
        }
        ...
        function()
        {
            ...
            $.ajax(
            {
                ...
                success : function(result, status, xhr)
                {
                    ...
                    $("#contenedor-cantidades").append( "<div class=\"col-sm-12\"></div>");
                ...
                complete : function( status, xhr )
                {
                    ...
                    $("[name='articulo']").val( "Elija un articulo" );
                    $("[name='costo']").text( "" );
                    $("[name='unidadA']").val( "" );
                }
            }); //  =>  ajax 
    ...
    $("select[name='articulo']").on(
        ...
        function()
        {
            ...
            if ( select_proveedor.val() )
            {
                ...
                //     data :
                //     {
                //         campos : "unidadA, factor, linea",
                //         condicion : "idArticulo = " + $(this).val(),
                //         salida_html : "dato",
                //         table : "articulo",
                //         operacion : "consultar-n-campos"
                //     },
                ...
                //         if ( unidadA != "" )
                //             $("input[name='unidadA']").val( unidadA );
                //         else
                //             $("input[name='unidadA']").val( "Ninguna" );
                //     }
                // }); //  =>  ajax
                ...
                //     {
                //         idArticulo : $(this).val(),
                //         idProveedor : select_proveedor.val(),
                //         operacion : "ocm-agregar-articulo"
                //     },
                //     success : function(result, status, xhr)
                //     {
                //         alert( result );
    ...
    // $("#agregar-articulo").on( "click", agregarArticuloAOrdenDeCompra );
