    ...
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <div class="form-group">
                ...
                <input class="form-control" name="idBase" value="" required="true" type="text" autofocus="true" maxlength="4" onkeydown="javascript: return event.keyCode === 8 || event.keyCode === 46 || event.keyCode === 13 ? true : !isNaN(Number(event.key))">
...
<script type="text/javascript">
    $("[name='idBase']").on({change : soloNumeros});
