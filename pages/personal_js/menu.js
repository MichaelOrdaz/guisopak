...
function joinOCM()
{
    ...
    table2 = {
        ...
        index_field : [
            "idOC AS Clave",
            "fechaI AS 'Fecha inicial'",
            "fechaF AS 'Fecha final'",
            "status AS Estado"
            ]
    };
    ...
    if( checarCamposRequire() )
    {
        ...
        $.ajax(
        {
            ...
            success : function(result, status, xhr)
            {
                ...
                {
                    textoAyuda( "Intente cambiar alguno de los datos requeridos, por ejemplo ingrese una clave diferente" );
                }
                else
                {
...
{
    $("select[id|='arg']").on("change", function()
    {
    ...
    // Clic en la pestana 'Consultar' o 'Eliminar'
    $("a[data-contexto]").on(
    {
        click: function()
        {
