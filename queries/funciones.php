<?php
	...
	function construir_tabla_simple()
	{
		...
		switch ( $_table_type_ )
		{
			...
			case "eliminar":
				$_response_ .= "<table class=\"table table-bordered\">";
			break;
	...
	function consulta_criterios_orden()
	{
		...
		echo json_encode( $_column_alias_ );
	}
	...
	function consultar()
	{
		global $_response_, $_column_names_, $_sql_query_, $_table_, $_operation_;
	...
	function inner_join()
	{
		global $_sql_query_, $_response_, $_num_cols_, $_query_result_;
