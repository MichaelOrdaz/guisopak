<?php
	...
	$_ocm_alias_ = array("id" => "Clave", "idOC" => "Clave órden de compra manual", "cliente" => "Nombre del cliente", "fechaI" => "Fecha inicial", "fechaF" => "Fecha final", "status" => "Estado", "fecha" => "Fecha", "usuario" => "Usuario");
